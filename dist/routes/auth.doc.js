...
const forgotPassword = {
    ...
    summary: 'for requesting for link to resset password by user who hass forgotten password after due verification',
    requestBody: {
        content: {
            'application/json': {
                schema: {
                    ...
                    properties: {
                        email: {
                            type: 'string',
                            decription: 'E-mail address Unique to just the user that was used to sign up initially',
                            example: 'Nigeria123@gamil.com',
                        },
                    },
                },
...
const resetPassword = {
    ...
    summary: 'for resetting to a new password after with the link to the reset password routes sent to the mail of the user along with the reset token',
    requestBody: {
        content: {
            'application/json': {
                schema: {
