            ...
            'application/json': {
                schema: {
                    ...
                    properties: {
                        receiver: {
                            type: 'string',
                            description: 'E-mail address of the for the to which the mail is being sent to',
                            example: 'receiver@gmail.com',
                        },
                        status: {
                            type: 'string',
                            description: 'status of the message, wether sent, draft or retracted',
                            example: 'draft',
                        },
                        heading: {
                            type: 'string',
                        ...
                        body: {
                            type: 'string',
                            description: 'Body of the mail to be sent which is the content of the mail',
                            example: 'I wish to apply for the positon as advertised in the media',
                        },
                    },
                },
            },
